...
| `ZOOMA2_MAX_STRINGS` | `1000` | No | Maximum strings accepted by the V2 and V3 map endpoints |
| `ZOOMA2_MAX_DEEP_STRINGS` | `200` | No | Maximum strings accepted when `deep=true` |
| `ZOOMA2_MAX_STRING_LENGTH` | `1000` | No | Maximum length of one string to map |
